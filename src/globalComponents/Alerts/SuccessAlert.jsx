    ...
    >
      <div className="flex w-full flex-col items-end space-y-4">
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <div className="pointer-events-auto w-full max-w-md overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 border border-green-200">
            <div className="px-4 py-3">
              <div className="flex items-center">
                ...
                <div className="ml-3 flex-1">
                  <p className="text-lg font-medium text-green-500">{title}</p>
